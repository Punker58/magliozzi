  ...
  if ($footer == null) :?>
          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 col-xxl-4" id="footerino">
              <h1>MAPPA DEL SITO</h1>
                <a href="/">HOME</a></br>
                <a href="pages/servizi">SERVIZI</a></br>
                <a href="pages/galleria">GALLERIA</a></br>
    ...
    <section id="copyright" class="copyright-c">
      ...
      <div class="container">
        <div class="col">
          <div class="copyright">
            <i style="padding-bottom:20px;">©2022 Magliozzi Group S.R.L - P.IVA:06940561217</i>
          </div>
        </div>
      </div>
